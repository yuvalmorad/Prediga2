    ...
    return React.createClass({
        ...
        render: function() {
           var props = this.props,
               game = props.game,
               mtachResult = props.mtachResult,
               predictionTeam1Goals = mtachResult && mtachResult[GAME.BET_TYPES.TEAM1_GOALS.key],
               predictionTeam2Goals = mtachResult && mtachResult[GAME.BET_TYPES.TEAM2_GOALS.key],
               predictionFirstToScore = mtachResult && mtachResult[GAME.BET_TYPES.FIRST_TO_SCORE.key],
               league = game.league,
